...
'''Analyzing solutions from https://github.com/hankcs/udacity-deep-learning/blob/master/3_regularization.py'''
# ---
# Problem 1
# ---------
#
...
with graph.as_default():
    ...
    loss = tf.reduce_mean(
        tf.nn.softmax_cross_entropy_with_logits_v2(logits=logits, labels=tf_train_labels)) + beta_regul * tf.nn.l2_loss(weights) #computes l2norm of a tensor sans. sqrt : output = sum(t ** 2) / 2
